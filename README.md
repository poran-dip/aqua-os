...
A fully functional glassmorphic desktop OS UI — built with nothing but HTML and CSS.
...
Every team was building with AI. The code wasn't the differentiator — the prompting was. Knowing what to build, how to describe it precisely, when to push for more detail, and how to iterate fast under a 2-hour clock. All 3360+ lines came from that process, and the result was a 12-app, fully interactive desktop OS with zero JavaScript.
